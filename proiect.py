# Într-o fabrică de producție, procesul de fabricație implică mai multe etape în care diverse componente
# și materiale sunt combinate pentru a crea produsul final. De exemplu, în cazul fabricării șamponului,
# procesul include combinarea substanțelor chimice, a apei și a materialelor de ambalare pentru a produce produsul final,
# care este un șampon. Pentru a asigura calitatea produselor,
# fabrica utilizează senzori pentru a monitoriza diverse caracteristici ale componentelor și ale produsului final.
# Aceste caracteristici au limite predefinite, iar orice abatere dincolo de aceste limite poate duce
# la eliminarea produsului pentru a menține standardele de calitate. Acest sistem ajută la economisirea
# resurselor și asigură consistența calității produsului.
...
# 0.Cerinta + task-uri
# 1. Conectarea la Baza de Date din Python;   1.75 - conectare git/push/pull
# 2. Crearea tabelelor in python  ;  2.5- script inserare date
# 3. Crearea modelelor pentr FastAPI
# 4. Creare API
# 5. Creare teste pentru API
# 6. Pipeline pentru GitHub actions
